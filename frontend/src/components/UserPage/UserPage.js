                        ...
                        <Grid container direction='column' spacing={1}>
                            <Grid item>
                                <table>
                                    <tbody>
                                    <tr>
                                        <td><Typography variant='body2' color='textSecondary'><Person/></Typography>
                                        </td>
                                        <td><Typography variant='body1'
                                                        color='textPrimary'>{user.firstName} {user.lastName} ({user.username})</Typography>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><Typography variant='body2' color='textSecondary'><Room/></Typography></td>
                                        <td><Typography variant='body1'
                                                        color='textPrimary'>{user.address.number} {user.address.street} {user.address.city} {user.address.postcode}</Typography>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><Typography variant='body2' color='textSecondary'><Email/></Typography></td>
                                        <td><Typography variant='body1' color='textPrimary'>{user.email}</Typography>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><Typography variant='body2'
                                                        color='textSecondary'><PhoneAndroid/></Typography></td>
                                        <td><Typography variant='body1' color='textPrimary'>{user.phone}</Typography>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <Grid item style={{alignSelf: 'flex-end'}}>
                                <Button size='small' color='primary' onClick={openEditDialog}>Edit Profile</Button>
                            </Grid>
                        </Grid>
                    </Paper>
                </Grid>
                <Grid item sm={7} direction='column' container spacing={2}>
                    ...
                    <Grid item>
                        ...
                        <Posts posts={watchings} page={offSetWatching + 1} onPageChange={handlePageChangeWatchings}
                               pageTotal={pageTotalWatching}/>
                    </Grid>
                </Grid>
            </Grid>
            <EditProfileDialog open={openEdit} onClose={closeEdit}/>
        </>
    )
}